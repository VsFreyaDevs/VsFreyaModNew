...
/**
 * had to take this from psych for now until i fix flixel-ui lol
 *
 * @see https://github.com/ShadowMario/FNF-PsychEngine/blob/main/source/backend/ui/PsychUIInputText.hx
 */
