...
class TransitionData implements IFlxDestroyable
{
   ...
   *
   * @param type          `NONE`, `TILE`, `DITHER`, or `FADE`
   ...
   */
  public function new(type = FADE, color = FlxColor.WHITE, duration = 1.0, ?direction:FlxPoint, ?tileData:TransitionTileData, ?region:FlxRect, cameraMode = TOP)
  {
    this.type = type;
